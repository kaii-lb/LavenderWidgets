...
echo "Signing...."
./apksigner/apksigner -J-enable-native-access=ALL-UNNAMED sign --in ./app/build/outputs/$target/${file}.apk --out widgets_signed_$tag.apk --key keys/releasekey.pk8 --cert keys/releasekey.x509.pem
echo "Signed!"
